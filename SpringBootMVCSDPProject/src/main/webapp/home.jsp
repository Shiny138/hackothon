...
<head>
    ...
    <style>
        body {
            ...
            background-color: linear-gradient(to right, #007bff, #ff7f00);
            padding: 0;
            margin: 0;
        }
        .container {
...
<div class="container">
    ...
    <div class="content">
    <p>Explore our services and find the support you need. Navigate through the different sections using the menu above to learn more about what we offer.</p>
    ...
    <div class="role-container">
        ...
        <c:if test="${userRole == 'student'}">
            <div class="role-section">
                ...
                <a href="book-appointment.jsp" class=""><button class="button-33" role="button">Book Appointment</button></a>
        ...
        <c:if test="${userRole == 'doctor'}">
            <div class="role-section">
                ...
                <a href="doctor-appointments.jsp" class="button-33"><button class="button-33" role="button">View Appointments</button></a>
